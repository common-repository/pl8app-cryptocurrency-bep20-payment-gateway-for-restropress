...
class pl8app_rpr_Settings {
	...
	public function get_next_carousel_address($cryptoId) {
		$carousel = new pl8app_rpr_Carousel($cryptoId);
	...
	public function get_hd_mode($cryptoId) {
		return apply_filters('pl8app_rpr_hd_mode', '0', $cryptoId);
	}
	...
	public function add_consumed_tx($cryptoId, $address, $txHash) {
		$settingsKey = 'pl8app_rpr_pro_' . $cryptoId . '_transactions_consumed_for_' . $address;
